...
within the inventory class functions have been implemented to dd, update and delete the brecords in this file.
...
There are also a few functions within the project that currrently are not in use, but they will be brought to use when the nnext phase of implementation for improving the application starts
